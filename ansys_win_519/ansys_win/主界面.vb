Public Class 主界面Form
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles 求解button.Click
        ...
        'PrintLine(input, "xx变量英文代号=" & Me.xx变量.Text)
        PrintLine(input, "")
        ...
        PrintLine(input, "")
        PrintLine(input, "!妲藉府")
        PrintLine(input, "text6=" & Me.TextBox6.Text / 1000)
        PrintLine(input, "sledg_dw_wd=+dgh_wd_dwn+Scb_wd+text6")
        PrintLine(input, "sledg_dw_hg=Lining1_hg+Lining2_hg+Lining3_hg+Lining4_hg+Cth_hg")
        PrintLine(input, "text8=" & Me.TextBox8.Text / 1000)
        PrintLine(input, "sledg_mid_wd=dgh_wd_dwn+Scb_wd-text8")
        PrintLine(input, "text11=" & Me.TextBox11.Text / 1000)
        PrintLine(input, "sledg_mid_hg=sledg_dw_hg+text11")
